...
import { onConnected, onDisconnected, onFoodCreated, onPositionSnapshot } from "../network/handle.event";
...
export function GamePage() {
  ...
  useEffect(() => {
    ...
    networkClient.on(EventSocket.FoodCreated, (data) => onFoodCreated(world, data));
